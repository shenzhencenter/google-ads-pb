...
var file_google_ads_googleads_v22_enums_asset_group_signal_approval_status_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_asset_group_signal_approval_status_proto_rawDescData []byte
)
