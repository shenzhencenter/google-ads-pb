...
var file_google_ads_googleads_v22_enums_legacy_app_install_ad_app_store_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_legacy_app_install_ad_app_store_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v22_enums_legacy_app_install_ad_app_store_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v22_enums_legacy_app_install_ad_app_store_proto_rawDesc), len(file_google_ads_googleads_v22_enums_legacy_app_install_ad_app_store_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
