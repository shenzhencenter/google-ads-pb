...
var file_google_ads_googleads_v22_enums_smart_campaign_not_eligible_reason_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_smart_campaign_not_eligible_reason_proto_rawDescData []byte
)
