...
var file_google_ads_googleads_v22_enums_custom_conversion_goal_status_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_custom_conversion_goal_status_proto_rawDescData []byte
)
