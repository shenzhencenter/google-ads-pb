...
var file_google_ads_googleads_v22_enums_account_link_status_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_account_link_status_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v22_enums_account_link_status_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_enums_account_link_status_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_enums_account_link_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v22_enums_account_link_status_proto_rawDesc), len(file_google_ads_googleads_v22_enums_account_link_status_proto_rawDesc)))
	})
