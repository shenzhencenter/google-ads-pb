...
var file_google_ads_googleads_v22_enums_user_list_number_rule_item_operator_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_user_list_number_rule_item_operator_proto_rawDescData []byte
)
