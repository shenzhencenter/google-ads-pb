...
var file_google_ads_googleads_v22_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v22_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v22_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_rawDesc), len(file_google_ads_googleads_v22_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
