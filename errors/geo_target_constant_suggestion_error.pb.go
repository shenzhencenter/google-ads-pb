...
var file_google_ads_googleads_v22_errors_geo_target_constant_suggestion_error_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_errors_geo_target_constant_suggestion_error_proto_rawDescData []byte
)
