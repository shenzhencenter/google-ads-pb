...
const file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDesc = "" +
	"\n" +
	...
	"#com.google.ads.googleads.v19.errorsB\x1aConversionActionErrorProtoP\x01ZEgithub.com/shenzhencenter/google-ads-pb/errors;errors\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V19.Errors\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V19\\Errors\xea\x02#Google::Ads::GoogleAds::V19::Errorsb\x06proto3"

var (
	file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDesc), len(file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDesc)))
	})
...
func file_google_ads_googleads_v19_errors_conversion_action_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDesc), len(file_google_ads_googleads_v19_errors_conversion_action_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
