...
var file_google_ads_googleads_v22_errors_custom_conversion_goal_error_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_errors_custom_conversion_goal_error_proto_rawDescData []byte
)
