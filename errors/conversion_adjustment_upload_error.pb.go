...
var file_google_ads_googleads_v22_errors_conversion_adjustment_upload_error_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_errors_conversion_adjustment_upload_error_proto_rawDescData []byte
)
