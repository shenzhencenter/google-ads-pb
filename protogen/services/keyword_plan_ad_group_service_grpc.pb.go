...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v14.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
