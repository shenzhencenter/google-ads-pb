...
type AssetGroup struct {
	...
	PrimaryStatus enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus `protobuf:"varint,11,opt,name=primary_status,json=primaryStatus,proto3,enum=google.ads.googleads.v14.enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus" json:"primary_status,omitempty"`
...
func (x *AssetGroup) Reset() {
	*x = AssetGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v14_resources_asset_group_proto_msgTypes[0]
...
func (*AssetGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v14_resources_asset_group_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v14_resources_asset_group_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v14_resources_asset_group_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x53, 0x74, 0x72,
...
var (
	file_google_ads_googleads_v14_resources_asset_group_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v14_resources_asset_group_proto_rawDescData = file_google_ads_googleads_v14_resources_asset_group_proto_rawDesc
)

func file_google_ads_googleads_v14_resources_asset_group_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v14_resources_asset_group_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v14_resources_asset_group_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v14_resources_asset_group_proto_rawDescData)
	})
	return file_google_ads_googleads_v14_resources_asset_group_proto_rawDescData
}

var file_google_ads_googleads_v14_resources_asset_group_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v14_resources_asset_group_proto_goTypes = []interface{}{
	...
	(enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus)(0),             // 2: google.ads.googleads.v14.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	(enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason)(0), // 3: google.ads.googleads.v14.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	(enums.AdStrengthEnum_AdStrength)(0),                                       // 4: google.ads.googleads.v14.enums.AdStrengthEnum.AdStrength
}
var file_google_ads_googleads_v14_resources_asset_group_proto_depIdxs = []int32{
	...
	2, // 1: google.ads.googleads.v14.resources.AssetGroup.primary_status:type_name -> google.ads.googleads.v14.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	3, // 2: google.ads.googleads.v14.resources.AssetGroup.primary_status_reasons:type_name -> google.ads.googleads.v14.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	4, // 3: google.ads.googleads.v14.resources.AssetGroup.ad_strength:type_name -> google.ads.googleads.v14.enums.AdStrengthEnum.AdStrength
...
func init() { file_google_ads_googleads_v14_resources_asset_group_proto_init() }
func file_google_ads_googleads_v14_resources_asset_group_proto_init() {
	if File_google_ads_googleads_v14_resources_asset_group_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v14_resources_asset_group_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v14_resources_asset_group_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v14_resources_asset_group_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v14_resources_asset_group_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v14_resources_asset_group_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v14_resources_asset_group_proto = out.File
	file_google_ads_googleads_v14_resources_asset_group_proto_rawDesc = nil
	file_google_ads_googleads_v14_resources_asset_group_proto_goTypes = nil
	file_google_ads_googleads_v14_resources_asset_group_proto_depIdxs = nil
}
