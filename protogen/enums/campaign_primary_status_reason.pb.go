...
func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_enumTypes[0].Descriptor()
}

func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_enumTypes[0]
}
...
func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignPrimaryStatusReasonEnum) Reset() {
	*x = CampaignPrimaryStatusReasonEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_msgTypes[0]
...
func (*CampaignPrimaryStatusReasonEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xc4, 0x08, 0x0a, 0x1f, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69,
	0x67, 0x6e, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xa0, 0x08, 0x0a, 0x1b, 0x43, 0x61,
	...
	0x44, 0x45, 0x52, 0x5f, 0x52, 0x45, 0x56, 0x49, 0x45, 0x57, 0x10, 0x24, 0x42, 0xfa, 0x01, 0x0a,
	...
	0x75, 0x6d, 0x73, 0x42, 0x20, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x50, 0x72, 0x69,
...
var (
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescData = file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDesc
)

func file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescData)
	})
	return file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDescData
}

var file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_init() }
func file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_init() {
	if File_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto = out.File
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_rawDesc = nil
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_goTypes = nil
	file_google_ads_googleads_v14_enums_campaign_primary_status_reason_proto_depIdxs = nil
}
