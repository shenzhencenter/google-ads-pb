...
const (
	AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName = "/google.ads.googleads.v16.services.AdGroupBidModifierService/MutateAdGroupBidModifiers"
)
