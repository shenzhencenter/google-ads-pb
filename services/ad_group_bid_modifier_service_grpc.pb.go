...
const (
	AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName = "/google.ads.googleads.v24.services.AdGroupBidModifierService/MutateAdGroupBidModifiers"
)
