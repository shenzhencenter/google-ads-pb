...
const (
	AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName = "/google.ads.googleads.v20.services.AdGroupBidModifierService/MutateAdGroupBidModifiers"
)
