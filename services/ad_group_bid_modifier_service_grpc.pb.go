...
const (
	AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName = "/google.ads.googleads.v13.services.AdGroupBidModifierService/MutateAdGroupBidModifiers"
)
