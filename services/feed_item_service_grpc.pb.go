...
const (
	FeedItemService_MutateFeedItems_FullMethodName = "/google.ads.googleads.v18.services.FeedItemService/MutateFeedItems"
)
...
// UnimplementedFeedItemServiceServer must be embedded to have
...
func (UnimplementedFeedItemServiceServer) testEmbeddedByValue()                         {}
...
func RegisterFeedItemServiceServer(s grpc.ServiceRegistrar, srv FeedItemServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeedItemServiceServer was
