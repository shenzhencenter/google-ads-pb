...
// UnimplementedExtensionFeedItemServiceServer must be embedded to have
...
func (UnimplementedExtensionFeedItemServiceServer) testEmbeddedByValue() {}
...
func RegisterExtensionFeedItemServiceServer(s grpc.ServiceRegistrar, srv ExtensionFeedItemServiceServer) {
	// If the following call pancis, it indicates UnimplementedExtensionFeedItemServiceServer was
