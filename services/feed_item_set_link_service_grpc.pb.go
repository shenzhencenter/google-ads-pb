...
const (
	FeedItemSetLinkService_MutateFeedItemSetLinks_FullMethodName = "/google.ads.googleads.v18.services.FeedItemSetLinkService/MutateFeedItemSetLinks"
)
...
// UnimplementedFeedItemSetLinkServiceServer must be embedded to have
...
func (UnimplementedFeedItemSetLinkServiceServer) testEmbeddedByValue() {}
...
func RegisterFeedItemSetLinkServiceServer(s grpc.ServiceRegistrar, srv FeedItemSetLinkServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeedItemSetLinkServiceServer was
