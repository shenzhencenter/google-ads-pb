...
const (
	AccountBudgetProposalService_MutateAccountBudgetProposal_FullMethodName = "/google.ads.googleads.v24.services.AccountBudgetProposalService/MutateAccountBudgetProposal"
)
