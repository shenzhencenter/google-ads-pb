...
const (
	AccountBudgetProposalService_MutateAccountBudgetProposal_FullMethodName = "/google.ads.googleads.v16.services.AccountBudgetProposalService/MutateAccountBudgetProposal"
)
