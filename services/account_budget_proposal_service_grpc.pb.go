...
const (
	AccountBudgetProposalService_MutateAccountBudgetProposal_FullMethodName = "/google.ads.googleads.v20.services.AccountBudgetProposalService/MutateAccountBudgetProposal"
)
