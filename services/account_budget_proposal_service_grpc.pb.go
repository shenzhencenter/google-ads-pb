...
const (
	AccountBudgetProposalService_MutateAccountBudgetProposal_FullMethodName = "/google.ads.googleads.v13.services.AccountBudgetProposalService/MutateAccountBudgetProposal"
)
