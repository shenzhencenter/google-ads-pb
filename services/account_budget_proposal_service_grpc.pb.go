...
const (
	AccountBudgetProposalService_MutateAccountBudgetProposal_FullMethodName = "/google.ads.googleads.v18.services.AccountBudgetProposalService/MutateAccountBudgetProposal"
)
