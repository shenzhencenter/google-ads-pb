...
const (
	CampaignBidModifierService_MutateCampaignBidModifiers_FullMethodName = "/google.ads.googleads.v16.services.CampaignBidModifierService/MutateCampaignBidModifiers"
)
