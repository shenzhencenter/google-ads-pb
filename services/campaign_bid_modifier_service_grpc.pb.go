...
const (
	CampaignBidModifierService_MutateCampaignBidModifiers_FullMethodName = "/google.ads.googleads.v24.services.CampaignBidModifierService/MutateCampaignBidModifiers"
)
