...
const (
	ConversionAdjustmentUploadService_UploadConversionAdjustments_FullMethodName = "/google.ads.googleads.v13.services.ConversionAdjustmentUploadService/UploadConversionAdjustments"
)
