...
func (x *SuggestGeoTargetConstantsRequest) Reset() {
	*x = SuggestGeoTargetConstantsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[0]
...
func (*SuggestGeoTargetConstantsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestGeoTargetConstantsResponse) Reset() {
	*x = SuggestGeoTargetConstantsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuggestGeoTargetConstantsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GeoTargetConstantSuggestion) Reset() {
	*x = GeoTargetConstantSuggestion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GeoTargetConstantSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *SuggestGeoTargetConstantsRequest_LocationNames) Reset() {
	*x = SuggestGeoTargetConstantsRequest_LocationNames{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuggestGeoTargetConstantsRequest_LocationNames) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SuggestGeoTargetConstantsRequest_GeoTargets) Reset() {
	*x = SuggestGeoTargetConstantsRequest_GeoTargets{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuggestGeoTargetConstantsRequest_GeoTargets) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_google_ads_googleads_v13_services_geo_target_constant_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDesc = []byte{
	...
	0x2a, 0x22, 0x1f, 0x2f, 0x76, 0x31, 0x33, 0x2f, 0x67, 0x65, 0x6f, 0x54, 0x61, 0x72, 0x67, 0x65,
...
var (
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescData = file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDesc
)

func file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDescData
}

var file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v13_services_geo_target_constant_service_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v13_services_geo_target_constant_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v13_services_geo_target_constant_service_proto_init() }
func file_google_ads_googleads_v13_services_geo_target_constant_service_proto_init() {
	if File_google_ads_googleads_v13_services_geo_target_constant_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*SuggestGeoTargetConstantsRequest_LocationNames_)(nil),
		(*SuggestGeoTargetConstantsRequest_GeoTargets_)(nil),
	}
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v13_services_geo_target_constant_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v13_services_geo_target_constant_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v13_services_geo_target_constant_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v13_services_geo_target_constant_service_proto = out.File
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_rawDesc = nil
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_goTypes = nil
	file_google_ads_googleads_v13_services_geo_target_constant_service_proto_depIdxs = nil
}
