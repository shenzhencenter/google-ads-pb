...
const (
	KeywordThemeConstantService_SuggestKeywordThemeConstants_FullMethodName = "/google.ads.googleads.v24.services.KeywordThemeConstantService/SuggestKeywordThemeConstants"
)
