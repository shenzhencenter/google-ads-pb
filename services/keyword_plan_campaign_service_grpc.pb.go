...
const (
	KeywordPlanCampaignService_MutateKeywordPlanCampaigns_FullMethodName = "/google.ads.googleads.v24.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns"
)
