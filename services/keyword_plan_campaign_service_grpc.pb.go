...
const (
	KeywordPlanCampaignService_MutateKeywordPlanCampaigns_FullMethodName = "/google.ads.googleads.v13.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns"
)
