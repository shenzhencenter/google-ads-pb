...
const (
	BiddingDataExclusionService_MutateBiddingDataExclusions_FullMethodName = "/google.ads.googleads.v18.services.BiddingDataExclusionService/MutateBiddingDataExclusions"
)
