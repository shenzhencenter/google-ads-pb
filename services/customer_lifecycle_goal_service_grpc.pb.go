...
const (
	CustomerLifecycleGoalService_ConfigureCustomerLifecycleGoals_FullMethodName = "/google.ads.googleads.v24.services.CustomerLifecycleGoalService/ConfigureCustomerLifecycleGoals"
)
