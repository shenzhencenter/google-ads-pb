...
const (
	CustomerLifecycleGoalService_ConfigureCustomerLifecycleGoals_FullMethodName = "/google.ads.googleads.v20.services.CustomerLifecycleGoalService/ConfigureCustomerLifecycleGoals"
)
