...
const file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDesc = "" +
	"\n" +
	...
	"%com.google.ads.googleads.v19.servicesB\x1cShareablePreviewServiceProtoP\x01ZIgithub.com/shenzhencenter/google-ads-pb/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"

var (
	file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDesc)))
	})
...
func file_google_ads_googleads_v19_services_shareable_preview_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_shareable_preview_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
