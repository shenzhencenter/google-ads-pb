...
const (
	FeedItemSetService_MutateFeedItemSets_FullMethodName = "/google.ads.googleads.v18.services.FeedItemSetService/MutateFeedItemSets"
)
...
// UnimplementedFeedItemSetServiceServer must be embedded to have
...
func (UnimplementedFeedItemSetServiceServer) testEmbeddedByValue()                            {}
...
func RegisterFeedItemSetServiceServer(s grpc.ServiceRegistrar, srv FeedItemSetServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeedItemSetServiceServer was
