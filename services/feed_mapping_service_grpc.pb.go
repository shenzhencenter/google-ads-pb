...
// UnimplementedFeedMappingServiceServer must be embedded to have
...
func (UnimplementedFeedMappingServiceServer) testEmbeddedByValue()                            {}
...
func RegisterFeedMappingServiceServer(s grpc.ServiceRegistrar, srv FeedMappingServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeedMappingServiceServer was
