...
// UnimplementedFeedItemTargetServiceServer must be embedded to have
...
func (UnimplementedFeedItemTargetServiceServer) testEmbeddedByValue()                               {}
...
func RegisterFeedItemTargetServiceServer(s grpc.ServiceRegistrar, srv FeedItemTargetServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeedItemTargetServiceServer was
