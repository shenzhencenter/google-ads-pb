...
const (
	CustomerFeedService_MutateCustomerFeeds_FullMethodName = "/google.ads.googleads.v18.services.CustomerFeedService/MutateCustomerFeeds"
)
...
// UnimplementedCustomerFeedServiceServer must be embedded to have
...
func RegisterCustomerFeedServiceServer(s grpc.ServiceRegistrar, srv CustomerFeedServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerFeedServiceServer was
