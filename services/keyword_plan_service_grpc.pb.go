...
const (
	KeywordPlanService_MutateKeywordPlans_FullMethodName         = "/google.ads.googleads.v13.services.KeywordPlanService/MutateKeywordPlans"
	KeywordPlanService_GenerateForecastCurve_FullMethodName      = "/google.ads.googleads.v13.services.KeywordPlanService/GenerateForecastCurve"
	KeywordPlanService_GenerateForecastTimeSeries_FullMethodName = "/google.ads.googleads.v13.services.KeywordPlanService/GenerateForecastTimeSeries"
	KeywordPlanService_GenerateForecastMetrics_FullMethodName    = "/google.ads.googleads.v13.services.KeywordPlanService/GenerateForecastMetrics"
	KeywordPlanService_GenerateHistoricalMetrics_FullMethodName  = "/google.ads.googleads.v13.services.KeywordPlanService/GenerateHistoricalMetrics"
)
...
func (c *keywordPlanServiceClient) GenerateForecastCurve(ctx context.Context, in *GenerateForecastCurveRequest, opts ...grpc.CallOption) (*GenerateForecastCurveResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeywordPlanService_GenerateForecastCurve_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keywordPlanServiceClient) GenerateForecastTimeSeries(ctx context.Context, in *GenerateForecastTimeSeriesRequest, opts ...grpc.CallOption) (*GenerateForecastTimeSeriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeywordPlanService_GenerateForecastTimeSeries_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keywordPlanServiceClient) GenerateForecastMetrics(ctx context.Context, in *GenerateForecastMetricsRequest, opts ...grpc.CallOption) (*GenerateForecastMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeywordPlanService_GenerateForecastMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keywordPlanServiceClient) GenerateHistoricalMetrics(ctx context.Context, in *GenerateHistoricalMetricsRequest, opts ...grpc.CallOption) (*GenerateHistoricalMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeywordPlanService_GenerateHistoricalMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanService_GenerateForecastCurve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeywordPlanService_GenerateForecastCurve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _KeywordPlanService_GenerateForecastTimeSeries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeywordPlanService_GenerateForecastTimeSeries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _KeywordPlanService_GenerateForecastMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeywordPlanService_GenerateForecastMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _KeywordPlanService_GenerateHistoricalMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeywordPlanService_GenerateHistoricalMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
