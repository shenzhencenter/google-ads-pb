...
const (
	CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_FullMethodName = "/google.ads.googleads.v20.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria"
)
