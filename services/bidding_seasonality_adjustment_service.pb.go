...
var file_google_ads_googleads_v22_services_bidding_seasonality_adjustment_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_services_bidding_seasonality_adjustment_service_proto_rawDescData []byte
)
