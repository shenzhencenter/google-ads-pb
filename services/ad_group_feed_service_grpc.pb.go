...
const (
	AdGroupFeedService_MutateAdGroupFeeds_FullMethodName = "/google.ads.googleads.v18.services.AdGroupFeedService/MutateAdGroupFeeds"
)
...
// UnimplementedAdGroupFeedServiceServer must be embedded to have
...
func (UnimplementedAdGroupFeedServiceServer) testEmbeddedByValue()                            {}
...
func RegisterAdGroupFeedServiceServer(s grpc.ServiceRegistrar, srv AdGroupFeedServiceServer) {
	// If the following call pancis, it indicates UnimplementedAdGroupFeedServiceServer was
