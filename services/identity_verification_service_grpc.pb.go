...
const (
	IdentityVerificationService_StartIdentityVerification_FullMethodName = "/google.ads.googleads.v16.services.IdentityVerificationService/StartIdentityVerification"
	IdentityVerificationService_GetIdentityVerification_FullMethodName   = "/google.ads.googleads.v16.services.IdentityVerificationService/GetIdentityVerification"
)
...
func (c *identityVerificationServiceClient) StartIdentityVerification(ctx context.Context, in *StartIdentityVerificationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, IdentityVerificationService_StartIdentityVerification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityVerificationServiceClient) GetIdentityVerification(ctx context.Context, in *GetIdentityVerificationRequest, opts ...grpc.CallOption) (*GetIdentityVerificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityVerificationService_GetIdentityVerification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
