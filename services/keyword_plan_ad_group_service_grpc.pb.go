...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v20.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
