...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v16.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
