...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v13.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
