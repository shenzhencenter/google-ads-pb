...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v24.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
