...
const (
	ThirdPartyAppAnalyticsLinkService_RegenerateShareableLinkId_FullMethodName = "/google.ads.googleads.v16.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId"
)
