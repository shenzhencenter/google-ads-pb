...
const (
	ThirdPartyAppAnalyticsLinkService_RegenerateShareableLinkId_FullMethodName = "/google.ads.googleads.v13.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId"
)
