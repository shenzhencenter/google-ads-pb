...
var file_google_ads_googleads_v22_services_customer_conversion_goal_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_services_customer_conversion_goal_service_proto_rawDescData []byte
)
