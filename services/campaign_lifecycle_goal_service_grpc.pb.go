...
const (
	CampaignLifecycleGoalService_ConfigureCampaignLifecycleGoals_FullMethodName = "/google.ads.googleads.v24.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals"
)
