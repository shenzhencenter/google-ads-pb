...
// UnimplementedCustomerExtensionSettingServiceServer must be embedded to have
...
func (UnimplementedCustomerExtensionSettingServiceServer) testEmbeddedByValue() {}
...
func RegisterCustomerExtensionSettingServiceServer(s grpc.ServiceRegistrar, srv CustomerExtensionSettingServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerExtensionSettingServiceServer was
