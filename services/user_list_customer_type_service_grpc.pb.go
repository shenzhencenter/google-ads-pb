...
const (
	UserListCustomerTypeService_MutateUserListCustomerTypes_FullMethodName = "/google.ads.googleads.v24.services.UserListCustomerTypeService/MutateUserListCustomerTypes"
)
