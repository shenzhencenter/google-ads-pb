...
const (
	UserListCustomerTypeService_MutateUserListCustomerTypes_FullMethodName = "/google.ads.googleads.v20.services.UserListCustomerTypeService/MutateUserListCustomerTypes"
)
