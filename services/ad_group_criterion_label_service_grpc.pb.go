...
const (
	AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_FullMethodName = "/google.ads.googleads.v20.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels"
)
