...
const (
	AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_FullMethodName = "/google.ads.googleads.v16.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels"
)
