...
var file_google_ads_googleads_v17_services_user_data_service_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v17_services_user_data_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*UploadUserDataRequest_CustomerMatchUserListMetadata)(nil),
	}
	file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*UserDataOperation_Create)(nil),
		(*UserDataOperation_Remove)(nil),
	}
	file_google_ads_googleads_v17_services_user_data_service_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
