...
var file_google_ads_googleads_v17_resources_media_file_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v17_resources_media_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*MediaFile_Image)(nil),
		(*MediaFile_MediaBundle)(nil),
		(*MediaFile_Audio)(nil),
		(*MediaFile_Video)(nil),
	}
	file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v17_resources_media_file_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
