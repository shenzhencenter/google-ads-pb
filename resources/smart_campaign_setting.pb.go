...
const file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDesc = "" +
	"\n" +
	...
	"&com.google.ads.googleads.v19.resourcesB\x19SmartCampaignSettingProtoP\x01ZKgithub.com/shenzhencenter/google-ads-pb/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"

var (
	file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDesc), len(file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDesc)))
	})
...
func file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDesc), len(file_google_ads_googleads_v19_resources_smart_campaign_setting_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
