...
var file_google_ads_googleads_v24_resources_data_link_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v24_resources_data_link_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v24_resources_data_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_data_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_data_link_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v24_resources_data_link_proto_rawDesc), len(file_google_ads_googleads_v24_resources_data_link_proto_rawDesc)))
	})
	return file_google_ads_googleads_v24_resources_data_link_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_data_link_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_data_link_proto_goTypes = []any{
	...
	(enums.DataLinkTypeEnum_DataLinkType)(0),     // 2: google.ads.googleads.v24.enums.DataLinkTypeEnum.DataLinkType
	(enums.DataLinkStatusEnum_DataLinkStatus)(0), // 3: google.ads.googleads.v24.enums.DataLinkStatusEnum.DataLinkStatus
}
var file_google_ads_googleads_v24_resources_data_link_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.DataLink.type:type_name -> google.ads.googleads.v24.enums.DataLinkTypeEnum.DataLinkType
	3, // 1: google.ads.googleads.v24.resources.DataLink.status:type_name -> google.ads.googleads.v24.enums.DataLinkStatusEnum.DataLinkStatus
...
func file_google_ads_googleads_v24_resources_data_link_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v24_resources_data_link_proto_rawDesc), len(file_google_ads_googleads_v24_resources_data_link_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
