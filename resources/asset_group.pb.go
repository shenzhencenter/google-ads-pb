...
func (x *AssetCoverage) Reset() {
	*x = AssetCoverage{}
	mi := &file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetCoverage) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_asset_group_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdStrengthActionItem) Reset() {
	*x = AdStrengthActionItem{}
	mi := &file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdStrengthActionItem) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_asset_group_proto_rawDescGZIP(), []int{2}
}
...
func (x *AdStrengthActionItem_AddAssetDetails) Reset() {
	*x = AdStrengthActionItem_AddAssetDetails{}
	mi := &file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdStrengthActionItem_AddAssetDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_asset_group_proto_rawDescGZIP(), []int{2, 0}
}
...
const file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc = "" +
	"\n" +
	...
	"&com.google.ads.googleads.v19.resourcesB\x0fAssetGroupProtoP\x01ZKgithub.com/shenzhencenter/google-ads-pb/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"
...
var file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_google_ads_googleads_v19_resources_asset_group_proto_init() {
	...
	file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[2].OneofWrappers = []any{
		(*AdStrengthActionItem_AddAssetDetails_)(nil),
	}
	file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
