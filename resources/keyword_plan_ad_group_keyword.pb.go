...
var file_google_ads_googleads_v22_resources_keyword_plan_ad_group_keyword_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v22_resources_keyword_plan_ad_group_keyword_proto_rawDescData []byte
)
