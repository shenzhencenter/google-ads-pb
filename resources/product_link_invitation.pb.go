...
var file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDesc = string([]byte{
...
var (
	...
	file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDescData []byte
)
...
func file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDesc), len(file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDesc)))
	})
	return file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDescData
}

var file_google_ads_googleads_v23_resources_product_link_invitation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v23_resources_product_link_invitation_proto_goTypes = []any{
	...
	(enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus)(0), // 4: google.ads.googleads.v23.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
	(enums.LinkedProductTypeEnum_LinkedProductType)(0),                     // 5: google.ads.googleads.v23.enums.LinkedProductTypeEnum.LinkedProductType
}
var file_google_ads_googleads_v23_resources_product_link_invitation_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v23.resources.ProductLinkInvitation.status:type_name -> google.ads.googleads.v23.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
	5, // 1: google.ads.googleads.v23.resources.ProductLinkInvitation.type:type_name -> google.ads.googleads.v23.enums.LinkedProductTypeEnum.LinkedProductType
...
func file_google_ads_googleads_v23_resources_product_link_invitation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDesc), len(file_google_ads_googleads_v23_resources_product_link_invitation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
