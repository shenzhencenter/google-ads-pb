...
func (x *Campaign_AssetAutomationSetting) Reset() {
	*x = Campaign_AssetAutomationSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_AssetAutomationSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_campaign_proto_rawDescGZIP(), []int{0, 18}
}
...
func (x *Campaign_VideoCampaignSettings_VideoAdInventoryControl) Reset() {
	*x = Campaign_VideoCampaignSettings_VideoAdInventoryControl{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Campaign_VideoCampaignSettings_VideoAdInventoryControl) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_campaign_proto_rawDescGZIP(), []int{0, 17, 0}
}
...
var file_google_ads_googleads_v17_resources_campaign_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
func file_google_ads_googleads_v17_resources_campaign_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[20].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[19].OneofWrappers = []any{}
	file_google_ads_googleads_v17_resources_campaign_proto_msgTypes[20].OneofWrappers = []any{}
	type x struct{}
